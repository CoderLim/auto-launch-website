...
- Plausible needs `PLAUSIBLE_API_TOKEN` (Sites API, Enterprise) in auto-launch-website `.env`. Stats/Events APIs are for querying or server-side tracking, not site provisioning.
